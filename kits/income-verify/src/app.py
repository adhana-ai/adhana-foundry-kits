...
ONE STUB, ONE EXTRACTION, on your machine, with your key. It is the proof that this runs on a
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE. 8768 is the next free one after
# docs-qa (8765), docs-extract (8766), asset-verify (8767).
...
class H(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        return self._send(200, {"id": sid, "fields": r["fields"],
                                "qualifying_monthly_income": r["qualifying_monthly_income"],
...
def main():
    ...
    print("income-verify UI  ->  http://127.0.0.1:%d" % a.port)
    print("  stubs: %d   fields: %d   API_KEY: %s"
