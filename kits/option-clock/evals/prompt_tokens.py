"""Measure the prompt split in TOKENS, not characters. Spends a few calls at max_tokens=1.
    ...
    python -m evals.prompt_tokens --run-id p001-option-clock --doc ROR-0001 --yes
...
⚑ THIS KIT HAS FOUR PARTS, NOT THREE, AND THE EXTRA ONE IS THE RULEBOOK. What starts a clock and
what perfects an extension are facts about a rulebook, so the rulebook has to be in the call --
which makes "how much of every call is the rulebook" a question a reader should be able to answer
...
def main():
    ...
    ap.add_argument("--doc", default="ROR-0001")
