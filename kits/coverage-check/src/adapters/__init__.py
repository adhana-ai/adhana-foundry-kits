...
def openai_compatible(cfg, system, user, max_tokens, thinking=None):
    ...
    Groq, Together, Mistral, xAI, Fireworks, and any local server (Ollama, LM Studio, vLLM).
...
# The one shape this kit will send, taken verbatim from the runtime provider's own published
