...
ONE RECORD, ONE EXTRACTION, on your machine, with your key. It is the proof that this runs on a
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE. 8771 is the next free one after
# docs-qa (8765), docs-extract (8766), asset-verify (8767), income-verify (8768),
# appraisal-extract (8769), credential-verify (8770).
...
class H(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        return self._send(200, {"id": sid, "fields": r["fields"],
                                ...
                                "break_quantity": r["break_quantity"],
...
def main():
    ...
    print("position-reconcile UI  ->  http://127.0.0.1:%d" % a.port)
