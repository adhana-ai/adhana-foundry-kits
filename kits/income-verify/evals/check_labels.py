...
def main():
    ...
    optional_fields = ("ytd_overtime_pay", "overtime_periods_paid", "overtime_periods_total",
                        "ytd_bonus_pay", "bonus_recurring")
    for stmt_id, r in by_id.items():
    ...
    if n_flagged == 0:
        ...
        print("  info  %d of %d stubs should be flagged (needs_review=true)"
              % (n_flagged, len(by_id)))
