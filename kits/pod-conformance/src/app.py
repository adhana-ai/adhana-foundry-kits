...
ONE PROOF-OF-DELIVERY RECORD, ONE EXTRACTION, on your machine, with your key. It is the proof that
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE. 8774 is the next free one after
...
# ae-seriousness (8772), coa-conformance (8773).
...
def main():
    ...
    print("pod-conformance UI  ->  http://127.0.0.1:%d" % a.port)
