"""Measure the prompt split in TOKENS, not characters. Spends a few calls at max_tokens=1.
    ...
    python -m evals.prompt_tokens --run-id p001-tuition-assess --doc STU-0001
...
def main():
    ...
    ap.add_argument("--doc", default="STU-0001")
    ...
    out = {"run_id": a.run_id, "doc": a.doc, "model": cfg.get("model"),
           "cumulative": list(zip(labels, counts)), "parts": parts, "total": counts[-1]}
