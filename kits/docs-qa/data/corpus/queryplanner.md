...
- Purchase   
 ...
 Query Planning   Table Of Contents 
...
# 4.  WITHOUT ROWID tables
 ...
 The basic principles described above apply to both ordinary rowid tables and WITHOUT ROWID tables. The only difference is that the rowid column that serves as the key for tables and that appears as the right-most term in indexes is replaced by the PRIMARY KEY.  
