...
ONE FILE, ONE EXTRACTION, on your machine, with your key. It is the proof that this runs on a
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE. 8770 is the next free one after
# docs-qa (8765), docs-extract (8766), asset-verify (8767), income-verify (8768),
# appraisal-extract (8769).
...
def main():
    ...
    print("credential-verify UI  ->  http://127.0.0.1:%d" % a.port)
    print("  files: %d   fields: %d   API_KEY: %s"
