...
ONE CASE REPORT, ONE EXTRACTION, on your machine, with your key. It is the proof that this runs on a
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE. 8772 is the next free one after
...
def main():
    ...
    print("ae-seriousness UI  ->  http://127.0.0.1:%d" % a.port)
