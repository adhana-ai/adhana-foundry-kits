...
ONE REPORT, ONE EXTRACTION, on your machine, with your key. It is the proof that this runs on a
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE. 8769 is the next free one after
...
def main():
    ...
    print("appraisal-extract UI  ->  http://127.0.0.1:%d" % a.port)
    print("  reports: %d   fields: %d   API_KEY: %s"
