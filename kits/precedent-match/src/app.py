...
WHAT IT IS FOR. One planned request, one match-and-draft call, on your machine, with your key. It
...
class H(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        return self._send(200, {
            ...
            "analog_event_ids": r["analog_event_ids"], "draft": r["draft"],
...
def main():
    ...
    print("precedent-match UI  ->  http://127.0.0.1:%d" % a.port)
