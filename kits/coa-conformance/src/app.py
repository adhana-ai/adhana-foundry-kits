...
ONE CERTIFICATE, ONE EXTRACTION, on your machine, with your key. It is the proof that this runs on
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE. 8773 is the next free one after
# docs-qa (8765), docs-extract (8766), asset-verify (8767), income-verify (8768),
# appraisal-extract (8769), credential-verify (8770), position-reconcile (8771),
# ae-seriousness (8772).
...
class H(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        return self._send(200, {"id": sid, "fields": r["fields"],
                                ...
                                "recomputed_conforms": r["recomputed_conforms"],
...
def main():
    ...
    print("coa-conformance UI  ->  http://127.0.0.1:%d" % a.port)
    print("  certificates: %d   fields: %d   API_KEY: %s"
