...
ONE STATEMENT, ONE EXTRACTION, on your machine, with your key. It is the proof that this runs on
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE -- see docs-extract's app.py for the full
# story of why. 8767 is the next free one after docs-qa (8765) and docs-extract (8766).
...
class H(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        return self._send(200, {"id": sid, "fields": r["fields"],
                                "computed_reserve_value": r["computed_reserve_value"],
                                "large_deposit_flag": r["large_deposit_flag"],
...
def main():
    ...
    print("asset-verify UI  ->  http://127.0.0.1:%d" % a.port)
    print("  statements: %d   fields: %d   API_KEY: %s"
