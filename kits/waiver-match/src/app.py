...
ONE PROGRESS-PAYMENT PACKAGE, ONE COVERAGE PASS, on your machine, with your key. It is the proof
...
# ⚑ EVERY KIT PICKS ITS OWN PORT SO TWO CAN RUN AT ONCE.
...
def main():
    ...
    print("waiver-match UI  ->  http://127.0.0.1:%d" % a.port)
    print("  packages: %d   fields: %d   API_KEY: %s"
