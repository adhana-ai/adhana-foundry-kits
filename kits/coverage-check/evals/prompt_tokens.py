"""Measure the prompt split in TOKENS, not characters. Spends three calls at max_tokens=1.

    python -m evals.prompt_tokens --run-id p001-coverage-check --doc WCL-0047
